    ...
    return (
        <AppBar position='sticky'>
            <Toolbar sx={{display:'flex',justifyContent:'space-between'}}>
                <Box><Typography sx={{display:{xs:'none',sm:'block'}}}>React-MUI</Typography>
            ...
            <Badge badgeContent={badge} color="error" sx={{display:{xs:'none',sm:'none',md:'block'}}}>
                <Mail />
                {/* <Notifications></Notifications> */}
            </Badge>
            <Badge badgeContent={notify} color="error" sx={{display:{xs:'none',sm:'none',md:'block'}}}>
                {/* <Mail /> */}
                <Notifications/>
            </Badge>
