...
const Rightbar = () => {
  return (
    ...
    >
      <Box width={300}>
        <Typography fontWeight={300}>Online Friends</Typography>
        <AvatarGroup max={5} sx={{ margin: "10px 0", marginBottom: "20px" }}>
        ...
        <Typography fontWeight={300}>Latest Photos</Typography>
        ...
        <Typography fontWeight={300} sx={{ margin: "10px 0" }}>
          Latest Conversation
        </Typography>
        <List
